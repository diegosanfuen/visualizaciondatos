...
public class Embedding_bacteriano extends PApplet {
...
public void convertirTablaAArray() {
...
public void convertirTablaLabsAArray() {
  // Llena el array con los datos de la tabla
  for (int i = 0; i < tabla.getRowCount(); i++) {     
...
public float[] screenXYZ(float x, float y, float z) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Embedding_bacteriano" };
    if (passedArgs != null) {
